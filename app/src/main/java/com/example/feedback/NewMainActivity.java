...
import com.example.feedback.databinding.ActivityNewMainBinding;
                ...
                .addOnCompleteListener(this, new OnCompleteListener<Boolean>() {
                    ...
                    public void onComplete(@NonNull Task<Boolean> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(NewMainActivity.this, "Fetch and activate succeeded",
                                    Toast.LENGTH_SHORT).show();

                        } else {
                            Toast.makeText(NewMainActivity.this, "Fetch failed",
                                    Toast.LENGTH_SHORT).show();
                        }
